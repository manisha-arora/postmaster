...
<table>
      ...
      <tr><td>Label:<input type="text" name="form[name]" value="<?php echo $edit_lable[0]->name; ?>" /><input type="submit" value="<?php
...
<?php foreach($lables as $val){ ?>
     <tr><td><?php echo $val->id; ?></td>
	     ...
	     <td><a href="index.php?controller=lable&action=edit&id=<?php echo $val->id;?>">Edit</a></td>
	     <td><a href="index.php?controller=lable&action=delete&id=<?php echo $val->id;?>">Delete</a></td>
    </tr>
 <?php }?>
</table>
</form>
