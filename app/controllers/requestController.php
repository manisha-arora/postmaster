...
class requestController extends Controller{
  ...
  public function send(){
	...
	if(isset($form['send'])){
     ...
     register_message('Please enter username','info');
     $error=true;
      }
	}
     if($error){
    ...
    if($request_object->isThereAFriendRequest($form['username'])) {
  ...
  public function acceptReject(){
    ...
    forward(get_url(array('request','pending')));
  }
   ...
   public function delete(){
    ...
    forward(get_url(array('request','friends')));	
   }	
}
