...
<div class="r-s-wdgt l-grey">
  <h5>Welcome <?php echo get_session_user()->fullName() ;?></h5>
   ...
   <div class="login">
		 <ul>
		   <li><a href="<?php echo get_url(array('email','compose')) ?>"><img src="<?php  echo web_root();?>/images/logo/compose.png" /></a></li>
		   <li><a href="<?php echo get_url(array('email')) ?>"><img src="<?php  echo web_root();?>/images/logo/inbox.png" /></a></li></a></li>
		   <li><a href="<?php echo get_url(array('email',sent)) ?>"><img src="<?php  echo web_root();?>/images/logo/sentmail.png" /></a></li>
		 </ul>
	 </div>
   </div>
